...
adata_sc  = sc.read_csv("GSM8341774_injected_3DE_genematrix.csv.gz")
...
# 遺伝子発現行列の読み込み
vis_matrix_path = 'GSM8341554_sample4_matrix.mtx.gz'
vis_genes_path = 'GSM8341554_sample4_features.tsv.gz'
vis_barcodes_path = 'GSM8341554_sample4_barcodes.tsv.gz'
...
# 6. 空間座標データの読み込み
# ----------------------------
tissue_positions_path = 'GSM8341554_sample4_tissue_positions_list.csv.gz'
...
cell_abundance.to_csv('cell_abundances4.csv')
