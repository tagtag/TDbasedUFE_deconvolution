...
adata_sc = pickle.load(open("adata_sc.pkl","rb"))
...
# 遺伝子発現行列の読み込み
vis_matrix_path = 'GSM8341551_sample1_matrix.mtx.gz'
vis_genes_path = 'GSM8341551_sample1_features.tsv.gz'
vis_barcodes_path = 'GSM8341551_sample1_barcodes.tsv.gz'
...
# 6. 空間座標データの読み込み
# ----------------------------
tissue_positions_path = 'GSM8341551_sample1_tissue_positions_list.csv.gz'
...
cell_abundance.to_csv('cell_abundances1.csv')
